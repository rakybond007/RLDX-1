#!/bin/bash
#SBATCH --job-name=train_rldx1_pt_image_libero_sail_eag_precision_60k_globalbatch32_2gpu
...
#SBATCH --output=out/%j-rldx1_libero_sail.out
#SBATCH --error=out/%j-rldx1_libero_sail.err

# SAIL reproduction on RLDX-1-PT-IMG: base + EAG + precision bit.
# Differs from finetune_rldx1_libero_image_2gpu.sh in exactly four places:
...
cd "$BASE_DIR"
DATA_DIR="${DATA_DIR:-/sjw_alinlab2/home/taekwan/sail_libero_delta_lerobot}"
...
RUN_NAME="${RUN_NAME:-rldx1_img_libero_sail_eag_gb32_60k}"
